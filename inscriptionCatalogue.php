        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Inscription sur catalogue</li>
                </ol>
                <h6 class="font-weight-bolder text-white mb-0">Gestion des catalogues</h6>
            </nav>
    ...
    <div class="container-fluid py-4">
                ...
                <div class="d-flex justify-content-md-end">
                    <div class="text-center mt-4">
                        <button class="btn btn-light btn-sm" onclick="showAddForm()">
                            <i class="fas fa-plus me-2"></i> Ajouter une inscription sur catalogue
                        </button>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center mt-1">
                    ...
                    <div class="dropdown mt-4">
                        ...
                        <ul class="dropdown-menu p-3" style="background-color: white; min-width: 100px;">
                            ...
                            <li><label><input type="checkbox" class="column-toggle" data-col="10" checked> Formation </label></li>
                            <li><label><input type="checkbox" class="column-toggle" data-col="11" checked> Session</label></li>
                            <li><label><input type="checkbox" class="column-toggle" data-col="15" checked> Commentaire</label></li>
                            <li><label><input type="checkbox" class="column-toggle" data-col="15" checked> date d'inscription</label></li>
        ...
        <table id="customers_table">
            ...
            <tr>
                ...
                <th>Formation  <span class="icon-arrow">&UpArrow;</span></th>
                <th>Session<span class="icon-arrow">&UpArrow;</span></th>
            ...
            <tbody id="table-body">
            <?php if (is_array($inscriptions) || is_object($inscriptions)): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onclick="showEditForm(this)"
                           ...
                           data-formation-proposition="<?php echo htmlspecialchars($inscription['formation']); ?>"

                           data-source-financement="<?php echo htmlspecialchars($inscription['session']); ?>"
    ...
    <div id="detailsCard" class="card position-fixed top-50 start-50 translate-middle shadow-lg"
                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Training -->
                                <div class="mb-3">
                                    <p><strong>Formation:</strong> <span id="detailFormation" class="fw-normal text-muted"></span></p>
                                </div>
                                <!-- Session -->
                                <div class="mb-3">
                                    <p><strong>Session:</strong> <span id="detailSession" class="fw-normal text-muted"></span></p>
                                </div>
                ...
                <div id="editCard" class="card position-fixed top-50 start-50 translate-middle shadow-lg"
                    ...
                    <div class="card-body p-3">
                        <form id="editForm" method="post" action="updateInscrireCatalogue.php">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="editPost">Poste<span class="text-danger"> *</span></label>
                                    <input type="text" id="editPost" name="post" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="editOrganisme">Organisme<span class="text-danger"> *</span></label>
                                    <input type="text" id="editOrganisme" name="organisme" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="editPays">Pays<span class="text-danger"> *</span></label>
                                    <input type="text" id="editPays" name="pays" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="editSource">Source<span class="text-danger"> *</span></label>
                                    <input type="text" id="editSource" name="source" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="editFormation">Formation<span class="text-danger"> *</span></label>
                                    <input type="text" id="editFormation" name="formation" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="editSession">Session<span class="text-danger"> *</span></label>
                                    <input type="text" id="editSession" name="session" class="form-control" required>
                                </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="date" id="editDateInscription" name="date_inscription" class="form-control" required>
                                </div>
                            </div>
                ...
                <div id="addParticipantCard" class="card position-fixed top-50 start-50 translate-middle shadow-lg"
                     style="display: none; max-width: 900px; width: 90%; background-color: #f8f9fa;">
                    <div class="card-header bg-gradient-success text-white p-3">
                        <h6 class="mb-0"><i class="fas fa-user-plus me-2"></i> Ajouter une inscription</h6>
                    </div>

                    <div class="card-body p-3">
                        <form id="addParticipantForm" method="post" action="addInscriptionCatalogue.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    <label for="addFormation">Formation<span class="text-danger"> *</span></label>
                                    <input type="text" id="addFormation" name="formation" class="form-control" required>
                                </div>

                                <div class="col-md-4 mb-2">
                                    <label for="addSession">Session<span class="text-danger"> *</span></label>
                                    <input type="text" id="addSession" name="session" class="form-control" required>
                                </div>
                ...
                <script>
                    function showDetails(data, id) {
                        ...
                        document.getElementById("detailFormation").innerText = data.formation;
                        document.getElementById("detailSession").innerText = data.session;
                ...
                <script>
                    ...
                    function showEditForm(button) {
                        ...
                        // Show the edit card
                        document.getElementById('editForm').action = 'updateInscrireCatalogue.php'; // Adjust the action if needed
        ...
        function deleteInscription(participantId) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('deleteInscrireCatalogue.php', {
                        method: 'POST',
                ...
                <script>
                    ...
                    function filterData() {
                        ...
                        let url = "inscriptionCatalogue.php?";
                        let params = [];
