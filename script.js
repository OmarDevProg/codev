...
excel_btn.onclick = () => {
    ...
    const ws = XLSX.utils.table_to_sheet(customers_table);
...
const downloadFile = function (data, fileType, fileName = 'file') {
    const a = document.createElement('a');
    a.download = `${fileName}.${fileType === 'excel' ? 'csv' : fileType}`; // Use `.csv` for Excel

    const mime_types = {
        'json': 'application/json',
        'csv': 'text/csv',
        'excel': 'text/csv', // Change Excel to CSV
    };
